...
SECRET_KEY = 'pd6d12%sctbp1f^h3uv9)o7pi5-hc_mt4u^1t5+&ba^931-n62'
...
TEMPLATES = [
    {
        ...
        'DIRS': [os.path.join(BASE_DIR + '/techpit', 'templates')],
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
...
MEDIA_ROOT = os.path.join(BASE_DIR + '/techpit','media')
